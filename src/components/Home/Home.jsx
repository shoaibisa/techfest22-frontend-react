    ...
    return (
        <div className="home">
            <div className="home__video py-5">
                <img className="homepage_gif" alt="" style={{
                    width: "100%",
                    overflow: "hidden"
                }} src={homapage_gif_vid} />
                <img className="homepage_gif_mobile" alt="" style={{
                    width: "100%",
                    overflow: "hidden"
                }} src={homapage_gif_vid} />
            ...
            <div className="Home__background">
                <div className="container-fluid top-0 logo_section text-light py-5">
                    <div className="logo_section_content">
                        <div className="  logo_section__image">
                            <img src={homepage_gif} className=" Logo_image" alt="" />
                        </div>
