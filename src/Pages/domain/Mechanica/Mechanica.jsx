...
const Chemfor = () => {
    ...
    useEffect(() => {
        axios.get(`${localUrl}/event/getByDomain/mechanica`).then(results => {
    ...
    return(
       ...
       <div className="subdomain">
        <EventLogo imgsrc={Mechanica}
        title="Mechanica" subTitle="They are doing what we do, eventually might do it all.
