...
const Chemfor = () => {
    ...
    useEffect(() => {
        axios.get(`${localUrl}/event/getByDomain/kermis`).then(results => {
    ...
    return(
       ...
       <div className="subdomain">
        <EventLogo imgsrc={Kermis}
        title="Kermis" subTitle="They are doing what we do, eventually might do it all.
